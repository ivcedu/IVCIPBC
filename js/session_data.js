...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
function isUserHasAccess() {        
    var result = new Array();
    result = db_getUserByEmail(sessionStorage.getItem('ss_ipbc_loginEmail'));
    if (result.length === 1) {
        sessionStorage.setItem('ss_ipbc_login_id', result[0]['UserID']);
        return true;
    }
    else {
        return false;
...
function removeDiacritics(str_value) {
    ...
    for (var i = 0; i < defaultDiacriticsRemovalMap.length; i++) {
        str_value = str_value.replace(defaultDiacriticsRemovalMap[i].letters, defaultDiacriticsRemovalMap[i].base);
    }

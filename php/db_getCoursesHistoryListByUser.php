<?php
    ...
    $query = "SELECT 'Blackboard' AS TableName, bkbd.TermCode, bkbd.SectionNum, bkbd.Instructor, tdci.CourseID, bkbd.Status, "
            . "CASE WHEN tdci.InstructionMethod = 'M72' THEN 'Online' WHEN tdci.InstructionMethod = 'M73' THEN 'Hybrid' ELSE 'Face 2 Face' END AS CourseType, bkbd.Minutes, bkbd.FileSize "
            ...
            . "CASE WHEN tdci.InstructionMethod = 'M72' THEN 'Online' WHEN tdci.InstructionMethod = 'M73' THEN 'Hybrid' ELSE 'Face 2 Face' END AS CourseType, '' AS Minutes, '' AS FileSize "
